...
3. check ```TODOs``` in [scripts/run.py](https://github.com/wutong8023/Auto-Bibfile/blob/master/scripts/run.py) and [scripts/utils.py](https://github.com/wutong8023/Auto-Bibfile/blob/master/scripts/utils.py) for customization.
